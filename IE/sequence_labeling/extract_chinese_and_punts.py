...
@function:
抽取中文和标点，百度--baseline
origin link: https://github.com/PaddlePaddle/PaddleNLP/blob/develop/examples/information_extraction/DuIE/extract_chinese_and_punct.py#L6
"""
...
class ChineseAndPunctuationExtractor:
    def __init__(self):
...
if __name__ == '__main__':
    ...
    text="韩邦庆（1856～1894）曾用名寄，字子云，别署太仙、大一山人、花也怜侬、三庆"

    print("～", cpe.is_chinese_or_punct("～"))
    print("~", cpe.is_chinese_or_punct("~"))
    print("―", cpe.is_chinese_or_punct("―"))
    print("-", cpe.is_chinese_or_punct("-"))